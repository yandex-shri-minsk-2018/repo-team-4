        ...
        return (
            <div className="login-layout">
                <div className="login-layout__logo">
                    <img src={logoSvg} className="login-layout__logo__img" />
                </div>
                <div className="login-form">
                    ...
                    <Button text="Get Started" highlighted={true} />
                    <Button text="Forgot Password?" highlighted={false} />
                </div>
                <div className="login-layout__footer">
                    ...
                    <Button text="Or Sign Up" highlighted={true} userClass="login-layout-button__sign-up-btn" />
                </div>
            </div>
        );
    }
